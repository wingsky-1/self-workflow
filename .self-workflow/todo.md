...
9. [done] 删除 `adr-review-template.md` 并更新相关文档 ✅
   → 来源：新增待评审
...
12. 文档受众分类落实——docs/ 中每篇文档标注 Human/Agent/共读，指导 Agent 按需加载
    → 来源：V1.6 延续
    <理解有误差>: 不是在文档中标注，而是形成spec指导Agent认识哪些文档（包括docs specs）受众是谁，站在受众的角度更好的去编写/评审文档
    应该落入V1.8
...
1. 任务标题描述生成的辨识度要高一些，可读写。不要用硬规则约束，发挥agent的能力去生成。简洁、易懂优先。
